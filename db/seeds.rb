...
##DATA BASE WAS SEEDED IN THIS FASHION, AND IT ONLY NEEDED TO BE SEEDED ONCE! DO NOT RESEED!
...
#     Beer.create(name: s["name"], description: s["description"], abv: s["abv"].to_i, brewery_id: Brewery.find_by(name:s["breweries"][0]["name"]).id, style_id: Style.find_by(name:s["style"]["shortName"]).id, img_url: s["labels"]["large"])
